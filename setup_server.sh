...
USER_INFO_ENDPOINT=$(echo $OUTPUTS | jq -r '.[] | select(.OutputKey == "UserInfoEndpoint") | .OutputValue')

echo "START_URL: $START_URL"
echo "TOKEN_ENDPOINT: $TOKEN_ENDPOINT"
echo "CLIENT_ID: $CLIENT_ID"
echo "COGNITO_JWKS_URL: $COGNITO_JWKS_URL"
echo "USER_INFO_ENDPOINT: $USER_INFO_ENDPOINT"
...
echo "USER_INFO_ENDPOINT=$USER_INFO_ENDPOINT" >> $DOTENV_FILENAME
